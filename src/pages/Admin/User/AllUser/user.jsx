...
function AllUser() {
  ...
  useEffect(() => {
    ...
    const fetchUsers = async () => {
      try {
        const userResponse = await fetch("https://farm-distribution-d0d1df93c0f1.herokuapp.com/all/akun", {
          method: "GET",
          headers: {
            login: token,
          },
    ...
    const fetchRoles = async () => {
      try {
        const roleResponse = await fetch("https://farm-distribution-d0d1df93c0f1.herokuapp.com/role", {
          method: "GET",
        });
    ...
    if (selectedRoleId) {
      try {
        ...
        const response = await fetch(
          `https://farm-distribution-d0d1df93c0f1.herokuapp.com/update/akun?id=${user.id_user}`,
          {
            method: "PUT",
            headers: {
  ...
  const handleDeleteAccount = async (user) => {
    ...
    if (confirmation.isConfirmed) {
      try {
        const response = await fetch(
          `https://farm-distribution-d0d1df93c0f1.herokuapp.com/delete/akun?id=${user.id_user}`,
          {
            method: "DELETE",
            headers: {
              login: token,
